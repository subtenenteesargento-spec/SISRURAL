const CACHE_NAME = 'sisrural-v10-7-fotos-propriedade-dev';
const APP_SHELL=[
  ...
  './icons/icon-192.png','./icons/icon-512.png','./icons/brasao-24bpmi.png','./js/mobile-dock.js'
];
...
// V10.7 DEV - fotos de referência da propriedade + acesso protegido no relatório
